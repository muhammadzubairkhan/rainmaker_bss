                     ...
                     <div class="col-md-3 col-sm-12 col-lg-3">
                      ...
                      <div class="col-md-4 col-sm-12 col-lg-4">
                        ...
                        <div class="form-group">
                          ...
                          <asp:TextBox ID="TextArea9" class="form-control" TextMode="multiline" Rows="5" placeholder="Deployment Remarks" runat="server" />
                      ...
                      <div class="col-md-4 col-sm-12 col-lg-4">
                         ...
                         <div class="form-group">
                          ...
                          <asp:TextBox ID="TextArea10" class="form-control" TextMode="multiline" Rows="5" placeholder="Operational Remarks" runat="server" />
                   ...
                   <form class="form-inline1 mt-2 mt-md-2 mb-md-3">
                    ...
                    <div class="row mb-md-3 mb-sm-3 border-box">
                      ...
                      <div class="col-md-5 col-sm-12 col-lg-5">
                        ...
                        <asp:TextBox ID="TextBox49" class="form-control mr-sm-2" runat="server"></asp:TextBox>
                ...
                <div id="complain-form" class="tab-pane">
                    ...
                    <div class="row mb-md-3 mb-sm-3 border-box">
                     ...
                     <div class="col-md-4 col-sm-12 col-lg-4">
                         ...
                         <asp:TextBox ID="TextBox50" class="form-control mr-sm-2" placeholder="Logged By" runat="server"></asp:TextBox>

                      </div>

                      <div class="col-md-4 col-sm-12 col-lg-4">

                         <asp:TextBox ID="TextBox51" class="form-control mr-sm-2" placeholder="Caller Name" runat="server"></asp:TextBox>
                      ...
                      <div class="col-md-4 col-sm-12 col-lg-4">
                         ...
                         <asp:TextBox ID="TextBox52" class="form-control mr-sm-2" placeholder="Caller Number" runat="server"></asp:TextBox>
                      ...
                      <div class="col-md-4 col-sm-12 col-lg-4">
                         ...
                         <asp:TextBox ID="TextBox53" class="form-control mr-sm-2" placeholder="POC Name" runat="server"></asp:TextBox>

                      </div>
                        
                      <div class="col-md-4 col-sm-12 col-lg-4">

                         <asp:TextBox ID="TextBox54" class="form-control mr-sm-2" placeholder="POC Number" runat="server"></asp:TextBox>
                      ...
                      <div class="col-md-4 col-sm-12 col-lg-4">
                         ...
                         <asp:TextBox ID="TextBox55" class="form-control mr-sm-2" placeholder="Deployment Complaint Received Date/Time" runat="server"></asp:TextBox>
                      ...
                      <div class="col-md-4 col-sm-12 col-lg-4">
                         ...
                         <asp:TextBox ID="TextBox56" class="form-control mr-sm-2" placeholder="Person Given ETA/ETTR" runat="server"></asp:TextBox>
                         
                      </div>
                        
                      <div class="col-md-4 col-sm-12 col-lg-4">

                         <asp:TextBox ID="TextBox57" class="form-control mr-sm-2" placeholder="ETA Date/Time" runat="server"></asp:TextBox>

                      </div>
                        
                      <div class="col-md-4 col-sm-12 col-lg-4">

                         <asp:TextBox ID="TextBox58" class="form-control mr-sm-2" placeholder="ETTR Date/Time" runat="server"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="text-right">
                                    ...
                                    <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="Save Complain"></asp:Button>
                    ...
                    <div class="row mb-md-3 mb-sm-3 border-box">
                      ...
                      <div class="col-md-10 col-sm-12 col-lg-10"> 
                         <label>
                             ...
                             <asp:TextBox ID="TextBox59" class="form-control mr-sm-2" placeholder="ctg" runat="server"></asp:TextBox>
