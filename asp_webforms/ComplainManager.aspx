            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="text-right">
                        ...
                        <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="Export to Excel"></asp:Button>
           ...
           <form class="form-inline1 mt-2 mt-md-2 mb-md-3">
              ...
              <div class="text-right">
                  <div class="checkbox">
                    ...
                    <label>
                        <asp:CheckBox ID="CheckBox2" runat="server" Text="SD Format"></asp:CheckBox>
                    </label>
